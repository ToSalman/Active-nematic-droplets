...
dataPath = 'E:\Data\droplets_9_2022\9_27_2022_K15_30_Ao12_fd30_stdPM\Ti2_Ham_20X_b1_Lvl15_exp200ms_41_2sInt_1\';
expFolders = [{'Pos4'}];
...
for sen=1:40
    for ed=9
        ...
        f1=50; %MTs channel begin
        f2=f1+150; %MTs channel end

        %specify analysis parameters
        diameterRange = [90 500]; %in pixels
