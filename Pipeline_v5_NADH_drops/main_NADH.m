...
expFolders = [{'Pos5_flicking' 'Pos6' 'Pos7' 'Pos8' 'Pos9' 'Pos10' 'Pos11' 'Pos12' 'Pos13' 'Pos34' 'Pos35' 'Pos36' 'Pos38' 'Pos39' 'Pos40' 'Pos41'  'Pos42'}];
...
%specify world parameters
        ...
        f1=40; %MTs channel begin
        f2=f1+60; %MTs channel end

        %specify analysis parameters
        diameterRange = [30 420]; %in pixels
        detectionSensitivity = 0.729;
        edgethresh=0.99;
        ...
        for n = 1:size(expFolders,2)
            ...
            saveas(gcf,[resultsPath,'\det_sen-',num2str(sen),'_ed-',num2str(ed),'.png'])
            %close
